...
?>
    ...
    <div class="customer-wrapper">
        ...
        <div class="admin-form-box" style="max-width:100%; margin-bottom:24px;">
            ...
            <form action="order_cancel.php" method="POST" style="margin-top:18px;" onsubmit="return confirm('Yakin mau membatalkan pesanan ini?');">
                <input type="hidden" name="order_id" value="<?= $order['id'] ?>">
                <button type="submit" class="btn-mini btn-remove">Batalkan Pesanan</button>
            </form>
            <?php endif; ?>
        </div>
