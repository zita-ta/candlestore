...
$pageTitle = "Serenity's Glow - Lilin Aromaterapi";
$includeLandingCss = true;

// Ambil produk yang ditandai featured buat slideshow
...
// Ambil 4 produk best seller (paling banyak terjual dari pesanan yang sudah selesai)
$stmtAll = $conn->query("
...
// Ambil testimoni terbaru dari customer
$stmtReviews = $conn->query("SELECT * FROM reviews ORDER BY created_at DESC LIMIT 4");
$reviews = $stmtReviews->fetchAll(PDO::FETCH_ASSOC);

// Hitung durasi animasi slideshow secara dinamis (biar cocok jumlah slide berapapun)
$secondsPerSlide = 4;
...
?>
    ...
    <!-- ================= HERO + SLIDESHOW ================= -->
    <section class="hero">
        <h1>Nyalakan Ketenangan, Rasakan Kehangatan</h1>
